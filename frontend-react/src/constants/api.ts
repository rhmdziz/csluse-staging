...
const API_AUTH_LOGIN_MICROSOFT = `${API_AUTH_BASE}/oauth/microsoft/login/`;
...
const API_USERS_MENTORS_DROPDOWN = `${API_USERS_BASE}/mentors/dropdown/`;
const API_USERS_DEPARTMENTS = `${API_USERS_BASE}/departments/`;
...
const API_AUTH_ADMIN_PROFILE_EXPORT = `${API_AUTH_ADMIN_PROFILE}export/`;
const API_AUTH_ADMIN_PROFILE_DETAIL = (id: string | number) =>
  `${API_AUTH_ADMIN_PROFILE}${id}/`;
const API_AUTH_ADMIN_PROFILE_CONFIRM_USER = (id: string | number) =>
  `${API_AUTH_ADMIN_PROFILE}${id}/confirm-user/`;
...
const API_AUTH_DEPARTMENTS = `${API_ADMIN_BASE}/departments/`;
const API_AUTH_DEPARTMENTS_BULK_DELETE = `${API_AUTH_DEPARTMENTS}bulk-delete/`;
const API_AUTH_DEPARTMENT_DETAIL = (id: string | number) =>
  `${API_AUTH_DEPARTMENTS}${id}/`;
...
const API_AUTH_PIC_USERS_BULK_ASSIGN = `${API_AUTH_PIC_USERS}bulk-assign/`;
...
const API_BOOKINGS_LEGACY_BULK_IMPORT = `${API_BOOKINGS}legacy-bulk-import/`;
...
const API_PENGUJIANS_LEGACY_BULK_IMPORT = `${API_PENGUJIANS}legacy-bulk-import/`;
...
const API_SURAT_BEBAS_LAB_BULK_DELETE = `${API_SURAT_BEBAS_LAB}bulk-delete/`;
const API_SURAT_BEBAS_LAB_DETAIL = (id: string) => `${API_SURAT_BEBAS_LAB}${id}/`;
const API_SURAT_BEBAS_LAB_DELETE = (id: string) => `${API_SURAT_BEBAS_LAB}${id}/`;
