      ...
      <table className="w-full min-w-[1000px] table-fixed">
        <thead className="border-b border-slate-800 bg-slate-900">
          <tr className="text-left text-sm">
            ...
            <th className="w-[170px] px-3 py-3 font-medium text-slate-50">Kategori</th>
            <th className="w-[140px] px-3 py-3 font-medium text-slate-50">Status</th>
            <th className="w-[100px] px-3 py-3 font-medium text-slate-50">Jumlah</th>
            <th className="w-[100px] px-3 py-3 font-medium text-slate-50">Satuan</th>
